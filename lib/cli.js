...
const sonarPullRequest = process.env.SONAR_PULL_REQUEST || '';
const sonarBranch = process.env.SONAR_BRANCH || '';
...
const params = {
  ...
  'sonar.pullRequest': sonarPullRequest,
  'sonar.branch': sonarBranch
};
